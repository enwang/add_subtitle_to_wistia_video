...
def _call_coherence_tool(lines: list[str], api_key: str, language: str | None) -> dict:
    ...
    prompt = (
        ...
        "2. Chinese finance terms mis-transcribed as phonetically similar non-finance characters "
        "(e.g. '止损' mis-heard as '至尊', '期货' mis-heard as '其货', '做空' mis-heard as '做功' — "
        "flag any non-finance word that sounds like a common finance term given the surrounding context)\n"
        "3. Known Whisper hallucination phrases such as: " + hallucination_examples + "\n"
        "4. Text that completely breaks the logical flow of the surrounding financial discussion\n"
        "5. Gibberish or random characters unrelated to speech\n\n"
